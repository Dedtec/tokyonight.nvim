...
function M.setup()
  ...
  theme.highlights = {
    ...
    TabLineSel = { fg = c.orange }, -- tab pages line, active tab page label
    ...
    ["@variable.builtin"] = { fg = c.dark5 }, -- Variable names that are defined by the languages, like `this` or `self`.
    ...
    -- Notify
    NotifyBackground = { fg = c.none, bg = c.bg },
    --- Border
